...
Vemos como el sistema que nos enfretamos es un windows antiguo por ello vamos a realizar un escaneo aún más concreto buscando las vulnerabilidades más básicas de windows antiguos como es `Eternal blue`.
...
Obtenemos los siguientes resultados en los que existen varios:
